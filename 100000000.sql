...
-- 100000000前 Level 1 所有新生成 Bid Order Queue
SELECT function_code, order_price, order_volume, cte.order, time FROM cte 
WHERE order_price = 112700 AND function_code = 83 AND cte.order NOT IN (
	SELECT ask_order FROM public."Transaction000001"
WHERE time <= 100000000
...
-- 100000000前 Level 1 所有新生成 Bid Order 数量
